...
import { f as school, o as galleryPhotos, s as heroPhotos } from "./school-BBKER8cz.mjs";
...
import { B as HeartHandshake, V as GraduationCap, at as BookOpen, f as Sparkles, i as Users } from "../_libs/lucide-react.mjs";
import { g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as SiteHeader, t as SiteFooter } from "./site-header-4Y24qqgy.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-r9EERhwy.js
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-brand text-accent",
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								className: "mt-6 max-w-2xl font-display text-4xl font-extrabold leading-tight md:text-6xl",
